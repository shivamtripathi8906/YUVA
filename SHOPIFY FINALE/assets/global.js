...
class FeaturedContainer extends HTMLElement{
  constructor() {
    super();
...
document.querySelectorAll('.tab__heading').forEach((heading) => {
  heading.addEventListener('click', (event) => {
    event.preventDefault();
    document.tabName = heading.dataset.tab;
    document.querySelectorAll('.tab__heading').forEach(
      (h) => h.classList.remove('is--active', 'font-black')
    );
    document.querySelectorAll('.tab__content').forEach(
      (c) => c.classList.remove('is--active')
    );
    heading.classList.add('is--active', 'font-black');
    console.log("#"+ document.tabName);
    document.querySelector('#' + document.tabName).classList.add('is--active');
  });
});
customElements.define('product-card' , FeaturedContainer);
